...
class JFormFieldModal_Cats extends JFormField
{
  ...
  protected function loadInputTypeStandard()
    ...
    if (typeof jQuery == 'undefined') {
       ...
       script.src = '".JUri::base()."components/com_content/helpers/jquery1.7.2.js';
...
';
    ...
    foreach($arr as $key => $value){      
      ...
      if($name = $db->loadResult()){        
        $titles .= "<li id='cid-".$value."' class='catz drag ui-state-default'><img src='".JURI::root()."administrator/components/com_multicats/assets/images/del.png' onclick=\"uncheckCat(id, ".$value.", &quot;&quot;, false);\"/>".$db->loadResult()."</li>";
