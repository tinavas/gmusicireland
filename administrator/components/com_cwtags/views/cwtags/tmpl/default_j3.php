...
<?php endif;?>
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input type="text" name="filter_search" placeholder="<?php echo JText::_('COM_CWTAGS_SEARCH_IN_TITLE'); ?>" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_CONTENT_FILTER_SEARCH_DESC'); ?>" />
			</div>
          ...
          <img src="<?php echo JUri::root().$itemparams->get('imageurl');?>" alt="image" style="max-width: 300px"/>
				...
				<td class="order">
					<?php if ($canChange) : ?>
						...
						<input type="text" name="order[]" size="5" style="width: 20px" value="<?php echo $item->ordering;?>" <?php echo $disabled; ?> class="text-area-order" />
					<?php else : ?>
