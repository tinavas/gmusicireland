	...
	function showForm()
	{
		...
		<div class="control-group">
			...
			<div class="controls">
				<fieldset id="type" class="radio">
					<input type="radio" id="type_kitchenSink" class="toggler" name="type" value="kitchenSink" <?php echo $this->params->type == 'kitchenSink' ? 'checked="checked"' : ''; ?> />
					<label for="type_kitchenSink"><?php echo JText::_('DC_KITCHENSINK'); ?></label>

					<input type="radio" id="type_paragraphs" class="toggler" name="type" value="paragraphs" <?php echo $this->params->type == 'paragraphs' ? 'checked="checked"' : ''; ?> />
					<label for="type_paragraphs"><?php echo JText::_('DC_PARAGRAPHS'); ?></label>

					<input type="radio" id="type_sentences" class="toggler" name="type" value="sentences" <?php echo $this->params->type == 'sentences' ? 'checked="checked"' : ''; ?> />
					<label for="type_sentences"><?php echo JText::_('DC_SENTENCES'); ?></label>

					<input type="radio" id="type_words" class="toggler" name="type" value="words" <?php echo $this->params->type == 'words' ? 'checked="checked"' : ''; ?> />
					<label for="type_words"><?php echo JText::_('DC_WORDS'); ?></label>

					<input type="radio" id="type_list" class="toggler" name="type" value="list" <?php echo $this->params->type == 'list' ? 'checked="checked"' : ''; ?> />
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="paragraphs_count" id="paragraphs_count" class="input-mini">
						<option value="1" <?php echo $this->params->paragraphs_count == 1 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J1'); ?></option>
						<option value="2" <?php echo $this->params->paragraphs_count == 2 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J2'); ?></option>
						<option value="3" <?php echo $this->params->paragraphs_count == 3 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J3'); ?></option>
						<option value="4" <?php echo $this->params->paragraphs_count == 4 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J4'); ?></option>
						<option value="5" <?php echo $this->params->paragraphs_count == 5 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J5'); ?></option>
						<option value="6" <?php echo $this->params->paragraphs_count == 6 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J6'); ?></option>
						<option value="7" <?php echo $this->params->paragraphs_count == 7 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J7'); ?></option>
						<option value="8" <?php echo $this->params->paragraphs_count == 8 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J8'); ?></option>
						<option value="9" <?php echo $this->params->paragraphs_count == 9 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J9'); ?></option>
						<option value="10" <?php echo $this->params->paragraphs_count == 10 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J10'); ?></option>
					</select>
				</div>
			</div>
		</div>
		...
		<div rel="type_sentences" class="toggle_div" style="display:none;">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="sentences_count" id="sentences_count" class="input-mini" value="<?php echo $this->params->sentences_count; ?>" />
				</div>
			</div>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="list_count" id="list_count">
						<option value="0" <?php echo !$this->params->list_count ? 'selected="selected"' : ''; ?>><?php echo JText::_('NN_RANDOM'); ?></option>
						<option value="2" <?php echo $this->params->list_count == 2 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J2'); ?></option>
						<option value="3" <?php echo $this->params->list_count == 3 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J3'); ?></option>
						<option value="4" <?php echo $this->params->list_count == 4 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J4'); ?></option>
						<option value="5" <?php echo $this->params->list_count == 5 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J5'); ?></option>
						<option value="6" <?php echo $this->params->list_count == 6 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J6'); ?></option>
						<option value="7" <?php echo $this->params->list_count == 7 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J7'); ?></option>
						<option value="8" <?php echo $this->params->list_count == 8 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J8'); ?></option>
						<option value="9" <?php echo $this->params->list_count == 9 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J9'); ?></option>
						<option value="10" <?php echo $this->params->list_count == 10 ? 'selected="selected"' : ''; ?>><?php echo JText::_('J10'); ?></option>
					</select>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<select name="list_type" id="list_type">
						<option value="" <?php echo !$this->params->list_type ? 'selected="selected"' : ''; ?>><?php echo JText::_('NN_RANDOM'); ?></option>
						<option value="ol" <?php echo $this->params->list_type == 'ol' ? 'selected="selected"' : ''; ?>><?php echo JText::_('DC_ORDERED'); ?></option>
						<option value="ul" <?php echo $this->params->list_type == 'ul' ? 'selected="selected"' : ''; ?>><?php echo JText::_('DC_UNORDERED'); ?></option>
					</select>
				</div>
			</div>
		</div>
		...
		if (JFactory::getApplication()->isAdmin())
		{
			...
			{
				echo '<em>' . str_replace('<a ', '<a target="_blank" ', html_entity_decode(JText::_('DC_SETTINGS'))) . '</em>';
			}
		}
		?>
		</div>
			...
			(function($) {
				nnDummyContent = {
					insertContent: function() {
						...
						var url = 'index.php?nn_qp=1&folder=plugins.editors-xtd.dummycontent&file=dummycontent.inc.php&generate_content=1&' + params.join('&');
						...
						switch ($('input[name=type]:checked').val()) {
							...
							case 'words':
								if ('<?php echo $this->params->type; ?>' != 'words' || $('[name=words_count]').val() != <?php echo $this->params->words_count; ?>) {
									params.push('s=' + $('[name=words_count]').val());
								}
								break;
							case 'list':
