 ...
 */
class CBSMTP			//BB: changed name to match CB library naming
{
    /**
    ...
    public function authenticate(
        ...
        switch ($authtype) {
            ...
            case 'NTLM':
                 ...
                 */
                //BB not needed with auto-loading:			require_once 'extras/ntlm_sasl_client.php';
                $temp = new stdClass();
                $ntlm_client = new CBNtlmSaslClient;		//BB renamed class
