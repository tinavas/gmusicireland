...
define('SASL_FAIL'    , 1);		//BB added
define('SASL_CONTINUE', 0);		//BB added
...
class CBNtlmSaslClient
{
	...
	Function Step(&$client, $response, &$message, /** @noinspection PhpUnusedParameterInspection */ &$interactions)
	{
		switch($this->state)
		{
