...
class ActionViewAdmin {
	 ...
	 *
	 */
	public static function editPluginView( $options, $actionPath, $viewModel, $data, $params, $pluginRow, $viewType, $cbprevstate ) {
		global $_CB_framework, $_CB_Backend_Title, $_PLUGINS, $ueConfig, $_GET;
		...
		if ( $showDisclaimer ) {
			...
			$disclaimerText			=	'This software comes "as is" with no guarrantee for accuracy, function or fitness for any purpose.';
			$disclaimerTitleTr		=	CBTxt::Th( 'Disclaimer' );
			$disclaimerTextTr		=	CBTxt::Th( 'This software comes "as is" with no guarrantee for accuracy, function or fitness for any purpose.' );
