...
abstract class moscomprofilerHTML
{
	 ...
	 */
	public static function makeOption( $value, $text = null, $valueName = 'value', $textName = 'text', $id = null, $class = null )
	{
		$option					=	new stdClass;
	 ...
	 * @return stdClass                 Selection object
	 */
	public static function makeOptGroup( $text = '', $valueName = 'value', $textName = 'text', $id = null, $class = null )
	{
		$option					=	new stdClass;
