...
<div id="list_carousel<?php echo $module->id; ?>" class="responsive list_carousel <?php echo $moduleclass_sfx? $params->get('moduleclass_sfx'):''; ?>">
	...
	<ul id="gmi-slider-all" style="width:<?php echo $moduleWidth.";"?>">
...
$(function() {
	$("ul.nav-tabs li a[href=#pane1]").click( function() {
		setTimeout(function() {
			$("#gmi-slider-all").trigger('updateSizes'); 
		}, 200);
	});
	//	Responsive layout, resizing the items
	$('#gmi-slider-all').carouFredSel({
