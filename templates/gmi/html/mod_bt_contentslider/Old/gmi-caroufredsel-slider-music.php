...
<div id="list_carousel<?php echo $module->id; ?>" class="responsive list_carousel <?php echo $moduleclass_sfx? $params->get('moduleclass_sfx'):''; ?>">
	...
	<ul id="gmi-slider-music" style="width:<?php echo $moduleWidth.";"?>">
	...
	<?php if( $next_back ) : ?>
		<a id="prev-music" class="prev" href="#"><div class="prev-arrow"></div></a>
		<a id="next-music" class="next" href="#"><div class="next-arrow"></div></a>
	<?php endif; ?>
	
	<?php if( $butlet == 1 ) : ?>
		<div id="pager-music" class="pager"></div>
	<?php endif; ?>
