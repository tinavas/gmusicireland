	...
	<ul id="gmi-carousel-videos">
		...
		<?php endforeach; ?>
			...
			<div class="clearfix"></div>
				<a id="prev-videos" class="prev" href="#"><div class="prev-arrow"></div></a>
				<a id="next-videos" class="next" href="#"><div class="next-arrow"></div></a>
				<!--div id="pager-videos" class="pager"></div-->
		</div>		
