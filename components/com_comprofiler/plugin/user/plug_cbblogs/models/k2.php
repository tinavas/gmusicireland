...
class cbblogsBlogTable extends OrderedTable
{
	...
	public function load( $id = null )
	{
		...
		if ( ! $article->get( 'id' ) ) {
			...
			if ( ! $this->get( 'catid' ) ) {
				$this->set( 'catid', (int) $plugin->params->get( 'blog_k2_category_default', null ) );
			}
	...
	public function bind( $array, $ignore = '', $prefix = null )
	{
		...
		if ( $bind ) {
			...
			$this->set( 'catid', (int) ( ( $plugin->params->get( 'blog_category_config', 1 ) || $isModerator ) ? Get::get( $array, 'category', $this->get( 'catid' ), GetterInterface::INT ) : $this->get( 'catid', $plugin->params->get( 'blog_k2_category_default', null ) ) ) );
